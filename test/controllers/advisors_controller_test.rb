...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference("Advisor.count") do
      post advisors_url, params: { advisor: { email: @advisor.email, firm_id: @advisor.firm_id, name: @advisor.name, phone: @advisor.phone } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { email: @advisor.email, firm_id: @advisor.firm_id, name: @advisor.name, phone: @advisor.phone } }
