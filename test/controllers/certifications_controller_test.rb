...
class CertificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certification" do
    assert_difference("Certification.count") do
      post certifications_url, params: { certification: { issuing_organization: @certification.issuing_organization, name: @certification.name } }
    end
  ...
  test "should update certification" do
    patch certification_url(@certification), params: { certification: { issuing_organization: @certification.issuing_organization, name: @certification.name } }
