...
class FirmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create firm" do
    assert_difference("Firm.count") do
      post firms_url, params: { firm: { city: @firm.city, name: @firm.name, website: @firm.website } }
    end
  ...
  test "should update firm" do
    patch firm_url(@firm), params: { firm: { city: @firm.city, name: @firm.name, website: @firm.website } }
